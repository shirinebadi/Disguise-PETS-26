...
private:
  std::string extract_value(const std::string& output, const std::string& label);
  std::string exec(const char* cmd);
  auth_result_t
                gen_auth_res_milenage(uint8_t* rand, uint8_t* autn_enb, uint8_t* res, int* res_len, uint8_t* ak_xor_sqn);
  auth_result_t
                gen_auth_res_milenage_vsim(uint8_t* rand, uint8_t* autn_enb, uint8_t* res, int* res_len, uint8_t* ak_xor_sqn);
